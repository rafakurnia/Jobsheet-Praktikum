...
function findProductBystok(products,stock){
  return products.filter(products => products.stock < 10);
}

function updatestock(products,id,newstok){
  return products.map(p =>
    p.id === id? {...p,stock: newstok} :p
  );
}



console.log(findProductById(products,24))
console.log(findProductBystok(products))
